...
from new_dataset4 import image_set
        ...
        if get_rank() == 0:
            ...
            if i % 10000 == 0:
                torch.save(
                    ...
                    f"checkpoint4/{str(i).zfill(6)}.pt",
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="/home/compu/ymh/FSMT/script/stylegan2-pytorch/checkpoint4/450000.pt", help="path to the checkpoints to resume training")
    ...
    if args.distributed:
        ...
        torch.distributed.init_process_group(backend="nccl", rank=0, world_size=2)#, init_method="env://")
        synchronize()
    ...
    #img_path = "/home/compu/ymh/FSMT/dataset/data/new_style2/"
    path1 = "/home/compu/ymh/FSMT/dataset/data/joint_tmp/"
    path2 = "/home/compu/ymh/FSMT/dataset/data/style_tmp/"

    imageset = image_set(path1, path2, True)
    #imageset = joint_set(img_path, True)
    loader = data.DataLoader(
        imageset,
        batch_size=args.batch,
        sampler=data_sampler(imageset, shuffle=True, distributed=args.distributed),
        drop_last=True
        )
