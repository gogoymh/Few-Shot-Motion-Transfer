...
from new_dataset4 import joint_set
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default="/home/compu/ymh/FSMT/script/stylegan2-pytorch/checkpoint5/190000.pt", help="path to the checkpoints to resume training")
    ...
    path = "/home/compu/ymh/FSMT/dataset/data/new_style2/"

    imageset = joint_set(path, True)
