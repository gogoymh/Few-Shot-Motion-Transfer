...
from new_architecture15 import Generator, Discriminator
from dataset2 import pair_set

'''
save_path = "/data1/ymh/FSMT/save/new_result24/"
model_name = "/data1/ymh/FSMT/save/" + "generator24.pth"

path1 = "/data1/ymh/FSMT/dataset/flip2_rendered/"
path2 = "/data1/ymh/FSMT/dataset/flip2/"

'''
save_path = "/home/compu/ymh/FSMT/save/new_result25/"
model_name = "/home/compu/ymh/FSMT/save/" + "generator25.pth"
...
for iteration in range(total):
    ...
    real = real.to(device)
    noise = Tensor(np.random.normal(0,1,(batch_size,16,1,1)))
