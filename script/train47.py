...
from new_architecture23 import Generator, Discriminator
...
'''
save_path = "/home/compu/ymh/FSMT/save/new_result47/"
model_name = "/home/compu/ymh/FSMT/save/" + "generator47.pth"
...
reference_from = reference_set(path2, 15, True)
...
for iteration in range(total):
    ...
    l1_loss = 100 * L1_loss(fake * semantic, real * semantic)
    ...
    if l1_loss.item() >= 1:
        ...
        fake = generator(joint, style[torch.randperm(4)], noise)
