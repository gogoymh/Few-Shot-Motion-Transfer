...
from new_architecture18 import Generator, Discriminator
from dataset3 import pair_set, joint_set


save_path = "/data1/ymh/FSMT/save/new_result30/"
model_name = "/data1/ymh/FSMT/save/" + "generator30.pth"
