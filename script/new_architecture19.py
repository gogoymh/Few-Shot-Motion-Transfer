...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.style1 = Style(6,32)
        self.style2 = Style(32,64)
        self.style3 = Style(64,128)
        self.style4 = Style(128,128)
    ...
    def forward(self, input_joint, query_joint, style, noise):
        
        content = self.content(input_joint)
        
        style1 = self.style1(torch.cat((query_joint, style), dim=1))
