...
'''
save_path = "/home/compu/ymh/FSMT/save/new_result60/"
model_name = "/home/compu/ymh/FSMT/save/" + "generator60.pth"
...
for pre_iteration in range(10):
    ...
    g_loss = l1_loss + global_l1_loss
    g_loss.backward()
    optimizer_G.step()
    print("[G:%f] [L1:%f] [Global:%f]" % (g_loss.item(), l1_loss.item(), global_l1_loss.item()))
