...
from new_architecture11 import Generator, Discriminator
from dataset2 import pair_set

'''
save_path = "/data1/ymh/FSMT/save/new_result18/"

path1 = "/data1/ymh/FSMT/dataset/flip_rendered/"
path2 = "/data1/ymh/FSMT/dataset/flip/"

'''
save_path = "/home/compu/ymh/FSMT/save/new_result21/"
...
for iteration in range(total):
    ...
    real = real.to(device)
    noise = Tensor(np.random.normal(0,1,(batch_size,15)))
