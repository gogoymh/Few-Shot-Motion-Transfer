...
'''
save_path = "/home/compu/ymh/FSMT/save/new_result52/"
model_name = "/home/compu/ymh/FSMT/save/" + "generator52.pth"
...
for iteration in range(total):
    ...
    l1_loss = (10 * 3 * 320 * 192 * L1_loss(fake * semantic, real * semantic))/mask_num
