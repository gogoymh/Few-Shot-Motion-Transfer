...
for epoch in range(200):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        n1_loss = adversarial_loss(discriminator(next_imgs1), first)
        ...
        n2_loss = adversarial_loss(discriminator(next_imgs2), first)
        ...
        n3_loss = adversarial_loss(discriminator(next_imgs3), first)
        ...
        if batches_done % 400 == 0:
            save_image(gen_imgs.data[:25], "images6/%d.png" % batches_done, nrow=5, normalize=True)