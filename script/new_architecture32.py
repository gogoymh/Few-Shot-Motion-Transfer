...
class Joint_Discriminator(nn.Module):
    def __init__(self):
        ...
        self.block2 = ResBlockDown(32, 256)
        self.block3 = ResBlockDown(256, 256)
        self.block4 = ResBlockDown(256, 256)
...
if __name__ == "__main__":
    ...
    a1 = torch.randn((2,3,320,192))#.to(device)
    a2 = torch.randn((2,3,320,192))#.to(device)
