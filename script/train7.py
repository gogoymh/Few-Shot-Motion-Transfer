...
from architecture3 import Generator1, Discriminator, Embedder
...
optimizer_D = torch.optim.Adam(discriminator.parameters(), lr=0.00015, betas=(0.5, 0.9))
...
for iteration in range(total):
    ...
    fake_imgs = generator(input_joint, y)

    real_validity = discriminator(real_imgs, joint)
    fake_validity = discriminator(fake_imgs.detach(), input_joint)
    '''
