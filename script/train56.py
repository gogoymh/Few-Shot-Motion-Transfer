...
'''
save_path = "/home/compu/ymh/FSMT/save/new_result56/"
model_name = "/home/compu/ymh/FSMT/save/" + "generator56.pth"
...
checkpoint = torch.load("/home/compu/ymh/FSMT/save/generator55.pth")
...
for iteration in range(total):
    ...
    g_loss.backward()
    optimizer_G.step()
    print("[g loss:%f] [L1 loss:%f] [G L1 loss:%f]" % (g_loss.item(), l1_loss.item(), global_l1_loss.item()))
