...
class Embedder(nn.Module):
    def __init__(self):
        ...
        self.style0 = Attention_style(3,16, False)
...
class Generator(nn.Module):
    ...
    def forward(self, landmark, style):
        ...
        style0, style1, style2, style3, style4, style5, style6 = style
...
class ResBlockDown(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.norm1 = Feature(out_channel)
        self.norm2 = Feature(out_channel)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.block1 = ResBlockDown(6, 16)
        self.block2 = ResBlockDown(16, 32)
        self.block3 = ResBlockDown(32, 64)
        self.block4 = ResBlockDown(64, 128)
        self.block5 = ResBlockDown(128, 256)
        self.block6 = ResBlockDown(256, 256)
        self.block7 = ResBlockDown(256, 512)
    ...
    def forward(self, x, y, style):
        ...
        out1 = self.block1(torch.cat((x,y), dim=1), style0)
        out2 = self.block2(out1, style1)
        out3 = self.block3(out2, style2)
        out4 = self.block4(out3, style3)
        out5 = self.block5(out4, style4)
        out6 = self.block6(out5, style5)
        out7 = self.block7(out6, style6)
        out = self.pool(out7)
...
if __name__ == "__main__":
    ...
    real = torch.randn((1,3,320,192)).to(device)
    ...
    real_validity, real_feature = discriminator(real, joint, style)
