...
class UpBlock(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.style3 = Feature(in_channel)
...
class Generator(nn.Module):
    ...
    def forward(self, landmark, style, noise):
        ...
        out = self.init_param.expand((noise.shape[0],1,5,3))
        out = out.expand((-1,512,5,3))
        
        out = self.up1(out, style6) + noise.expand((noise.shape[0],256,10,6))
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.block3 = self.make_layer(15, 512, 1024)
